...
const getCrawlerColor = (crawler: string) => {
  switch (crawler) {
    case "GPTBot": return "bg-green-900/20 text-green-400 border-green-800";
    case "ClaudeBot": return "bg-purple-900/20 text-purple-400 border-purple-800";
    case "Bytespider": return "bg-blue-900/20 text-blue-400 border-blue-800";
    case "GoogleOther": return "bg-orange-900/20 text-orange-400 border-orange-800";
    ...
    <>
      ...
      <header className="bg-dark-card border-b border-dark-border px-8 py-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-dark-primary">Crawlers</h1>
            <p className="text-sm text-dark-secondary mt-1">Monitor AI bot activity on your site</p>
          </div>
        ...
        <Card className="dark-card mb-8">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-dark-primary">
              <Bot className="w-5 h-5 text-dark-cta" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card className="dark-card">
            <CardHeader>
              ...
              <CardDescription className="text-dark-secondary">Pages with highest bot activity</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow className="border-dark-border hover:bg-dark-table-hover">
                    ...
                    <TableHead className="font-semibold text-dark-primary text-right">Crawls</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
          ...
          <Card className="dark-card">
            <CardHeader>
              ...
              <CardDescription className="text-dark-secondary">Latest bot activity on your site</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow className="border-dark-border hover:bg-dark-table-hover">
                    <TableHead className="font-semibold text-dark-primary">Crawler</TableHead>
                    <TableHead className="font-semibold text-dark-primary">Path</TableHead>
                    <TableHead className="font-semibold text-dark-primary">Time</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {recentCrawls.map((crawl, index) => (
                    <TableRow key={index} className="border-dark-border hover:bg-dark-table-hover">
                      ...
                      <TableCell>
                        <span className="text-sm text-dark-primary truncate block max-w-xs">
                          {crawl.path}
                        </span>
                      </TableCell>
                      <TableCell>
                        <span className="text-sm text-dark-secondary">{crawl.timestamp}</span>
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 rounded-xl bg-blue-900/20 flex items-center justify-center">
                  <Bot className="w-6 h-6 text-dark-cta" />
                </div>
                <div>
